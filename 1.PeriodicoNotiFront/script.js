...
function renderizarNoticia(noticia){
    ...
    <article class="tarjeta">
        ...
        <div>
            ...
            <i class="fas fa-star"></i><i class="fas fa-share-alt"></i>
            <i class="fas fa-ellipsis-h"></i>
        </div>
    </article>
    `;

    const contenedorNoticias = document.querySelector(tipoNoticia(noticia));
    contenedorNoticias.innerHTML += template;
}

function tipoNoticia(noticia){
    return noticia.tipoNacional ? '.contenedorNacional' : '.contenedorInternacional'
}